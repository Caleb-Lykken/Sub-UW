  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <SafeAreaView style={styles.buttonRow}>
        ...
        <TouchableOpacity style={[styles.button, styles.cancel]} onPress={() => router.navigate('/Profile')}>
          <Text style={styles.buttonText}>Cancel</Text>
        </TouchableOpacity>

        <TouchableOpacity style={[styles.button, styles.confirm]} onPress={() => router.navigate('/Profile')}>
